...
function configureAndInstall() {
        ...
        curl -o Makefile_containerd.diff https://$TOKEN@raw.github.ibm.com/loz/opensource-porting-s390x/master/Docker-CE/scripts/${PACKAGE_VERSION}/patch/Makefile_containerd.diff
        patch --ignore-whitespace Makefile Makefile_containerd.diff
        curl -o Dockerfile.rpm.diff https://$TOKEN@raw.github.ibm.com/loz/opensource-porting-s390x/master/Docker-CE/scripts/${PACKAGE_VERSION}/patch/Dockerfile.rpm.diff
        ...
        curl -o Makefile_rpm_docker-ce-packaging.diff https://$TOKEN@raw.github.ibm.com/loz/opensource-porting-s390x/master/Docker-CE/scripts/${PACKAGE_VERSION}/patch/Makefile_rpm_docker-ce-packaging.diff
